...
declare KA9Q_REQUIRED_COMMIT_SHA="${KA8Q_REQUIRED_COMMIT_SHA-57faf09196356817659e3d38aacad53e32238cc6}"
...
function ka9q_setup()
{
    ...
    if [[ -f  ${KA9Q_RADIO_NWSIDOM} ]]; then
        ...
        time fftwf-wisdom -v -T 1 -o nwisdom rof500000 cof36480 cob19200 cob1920 cob1200 cob960 cob800 cob600 cob480 cob320 cob300 cob200 cob160
        rc=$?
        cd - > /dev/null
        if [[ ${rc} -ne 0 ]]; then
