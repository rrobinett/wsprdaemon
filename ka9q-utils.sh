...
declare GITHUB_PROJECTS_LIST=(
    "ka9q-radio        ${KA9Q_WEB_COMMIT_CHECK-yes}     ${KA9Q_WEB_EABLED-yes}      build_ka9q_radio    ${KA9Q_RADIO_LIBS_NEEDED// /,}  ${KA9Q_RADIO_GIT_URL-https://github.com/ka9q/ka9q-radio.git}               ${KA9Q_WEB_COMMIT-1ee42250a2d4ce42d53c9ccdca81a73301f6a9ed}"
    ...
    "ka9q-web          ${KA9Q_WEB_COMMIT_CHECK-yes}     ${KA9Q_WEB_ENABLED-yes}     build_ka9q_web      NONE                            ${KA9Q_WEB_GIT_URL-https://github.com/scottnewell/ka9q-web}                ${KA9Q_WEB_COMMIT-0191d3f5f475388905da1eb7e6877dd743046c06}"
)
