...
declare GITHUB_PROJECTS_LIST=(
    ...
    "ft8_lib           ${KA9Q_FT8_COMMIT_CHECK-yes}     ${KA9Q_FT8_ENABLED-yes}     build_ka9q_ft8      NONE                            ${KA9Q_FT8_GIT_URL-https://github.com/ka9q/ft8_lib.git}                    ${KA9Q_FT8_COMMIT-f579386c6963cf11fd9e116e4d6972a0cac687fd}"
