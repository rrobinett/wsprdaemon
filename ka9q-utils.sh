...
declare GITHUB_PROJECTS_LIST=(
    "ka9q-radio        ${KA9Q_RADIO_COMMIT_CHECK-yes}   ${KA9Q_WEB_EABLED-yes}      build_ka9q_radio    ${KA9Q_RADIO_LIBS_NEEDED// /,}  ${KA9Q_RADIO_GIT_URL-https://github.com/ka9q/ka9q-radio.git}               ${KA9Q_WEB_COMMIT-35df315189b22d80065009b93614ff323d9e38fa}"
