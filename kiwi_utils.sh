...
function get_kiwi_status()
{
    ...
    local mutex_name="kiwi_status"
    local kiwi_status_dir="${PWD}/../${mutex_name}.d"          ### The directory where we will put the cached Kiwi status information
    ...
    local kiwi_status_cache_file="${kiwi_status_dir}/${mutex_name}.cache"         ### The file which contains the cached Kiwi status information

    wd_logger 1 "Locking access to status directory of Kiwi '${kiwi_ip_port}'"
