...
### IF RAC=<INT> is defined in wsprdaemon.conf, these allow the user 'wsprdaemon' on WD0 and WD00 to ssh auto-login through the reverse tunnel created by WD's RAC service
declare WD0_PUBLIC_KEY="ssh-rsa  wsprdaemon@WD0"
declare WD00_PUBLIC_KEY="ssh-rsa  wsprdaemon@WD00"
